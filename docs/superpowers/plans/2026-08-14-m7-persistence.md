...
- v2 migration note: an older client rejecting a newer-version save must back it up (beastoria.save.bak) or suppress autosave, else it wipes real progress after a future v2 deploy.
